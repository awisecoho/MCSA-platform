...
export async function GET(req: Request) {
  ...
  try {
    ...
    const modules = [
      ['mcsa-101-introduction','Why Municipal Claims Require a Different Approach',20,true,0],
      ['mcsa-101-introduction','The Municipal Claims Lifecycle',15,false,1],
      ['mcsa-101-introduction','The Municipal Claims Ecosystem',15,false,2],
      ...
      ['mcsa-107-police-vehicles','Police Platforms — Factory Differences That Matter',25,true,0],
      ['mcsa-107-police-vehicles','Emergency Lighting — Identification, Systems & Estimation',30,false,1],
      ['mcsa-107-police-vehicles','Interior Systems — Consoles, Partitions & Communications',25,false,2],
      ['mcsa-107-police-vehicles','Police Vehicle Claims — Full Scenario Assessment',35,false,3],
      ['mcsa-108-ambulance','Ambulance Classification & Manufacturer Overview',20,true,0],
      ['mcsa-108-ambulance','Module Systems & Electrical Architecture',35,false,1],
      ['mcsa-108-ambulance','The Remount Decision',25,false,2],
      ['mcsa-108-ambulance','Total Loss Analysis for Ambulances',20,false,3],
      ['mcsa-108-ambulance','Ambulance Claims — Full Assessment',35,false,4],
      ...
      ['mcsa-109-fire-apparatus','Integrated Systems — How They Connect',35,false,2],
    ...
    const resources = [
      ...
      { title:'APCO International — Municipal Communications Overview', category:'Reference Guide', type:'link', course_slug:'mcsa-101-introduction', source_name:'APCO International', url:'https://www.apcointl.org/technology-and-communications/standards/', description:'Public safety communications standards. Background context for understanding how municipalities operate and the interdependencies that make apparatus downtime a public safety issue.', access_level:'free' },
      { title:'NFPA — Emergency Vehicle Standards Library', category:'Standards', type:'link', course_slug:'mcsa-101-introduction', source_name:'NFPA', url:'https://www.nfpa.org/codes-and-standards/all-codes-and-standards/list-of-codes-and-standards?mode=cat&cat=FDEquip', description:'Full index of NFPA standards governing emergency vehicles — 1901 (fire apparatus), 1911 (inspection), 1917 (ambulances), 1071 (EVT). Know which standard governs the vehicle you are working on.', access_level:'free' },
      { title:'IAFC — Emergency Vehicle Safety Initiative', category:'Reference Guide', type:'link', course_slug:'mcsa-101-introduction', source_name:'International Association of Fire Chiefs', url:'https://www.iafc.org/topics-and-tools/resources/detail/emergency-vehicle-safety-initiative', description:'Context for why return-to-service standards matter — covers crash statistics, apparatus safety, and why a compromised vehicle cannot return to service without proper inspection.', access_level:'free' },

      // ── MCSA-102 Vehicle Classification ─────────────────────────────────
      { title:'Ford Police Vehicles — Full Product Line', category:'OEM', type:'link', course_slug:'mcsa-102-vehicle-classification', source_name:'Ford Motor Company', url:'https://www.ford.com/police-vehicles/', description:'Complete Ford law enforcement product line — PIU, F-150 Police Responder, Maverick, and Transit. Use for platform identification and understanding factory differences between models.', access_level:'free' },
      { title:'GM Fleet — Tahoe PPV & Silverado SSV', category:'OEM', type:'link', course_slug:'mcsa-102-vehicle-classification', source_name:'GM Fleet', url:'https://www.gmfleet.com/police-pursuit-vehicles/', description:'Chevrolet police platform overview — Tahoe PPV, Silverado SSV. Body-on-frame vs unibody distinctions, factory police-specific features. Never use civilian Tahoe data on a PPV.', access_level:'free' },
      { title:'Stellantis — Dodge Durango Pursuit', category:'OEM', type:'link', course_slug:'mcsa-102-vehicle-classification', source_name:'Stellantis Fleet', url:'https://www.stellantisfleet.com/law-enforcement', description:'Dodge Durango Pursuit platform documentation. Factory law enforcement differences from civilian Durango — suspension, alternator, pre-wired circuits.', access_level:'free' },

      // ── MCSA-103 Documentation Standards ────────────────────────────────
      { title:'NICB — Vehicle Inspection Guide', category:'Reference Guide', type:'link', course_slug:'mcsa-103-documentation-standards', source_name:'National Insurance Crime Bureau', url:'https://www.nicb.org/prevent-fraud-theft/vehicle-fraud', description:'Framework for thorough vehicle inspection and documentation. Complements MCSA photo standards with fraud-awareness context for pre-existing condition documentation.', access_level:'free' },
      { title:'NHTSA — VIN Decoder', category:'Reference Guide', type:'link', course_slug:'mcsa-103-documentation-standards', source_name:'NHTSA', url:'https://vpic.nhtsa.dot.gov/decoder/', description:'Official NHTSA VIN decoder — confirms year, make, model, body style, and engine. Use to verify unit identity when VIN plate is damaged or illegible at inspection.', access_level:'free' },

      // ── MCSA-104 Labor Control ────────────────────────────────────────────
      { title:'Whelen Training — WEVT Certification Program', category:'Training', type:'link', course_slug:'mcsa-104-labor-control', source_name:'Whelen Engineering', url:'https://www.whelen.com/whelen-training', description:'Free Whelen EVT training covering all product families. Understanding actual installation complexity is essential for applying MCSA labor ranges — this is the shop-side reference.', access_level:'free' },
      { title:'Havis — Installation Resource Center', category:'OEM', type:'link', course_slug:'mcsa-104-labor-control', source_name:'Havis', url:'https://www.havis.com/resource-center/', description:'Havis installation guides for consoles, docking stations, and mounts. The labor complexity you see in these guides is what your decomposition should reflect.', access_level:'free' },

      // ── MCSA-105 Valuation ────────────────────────────────────────────────
      { title:'Whelen — Product Catalog and Pricing', category:'OEM', type:'link', course_slug:'mcsa-105-valuation', source_name:'Whelen Engineering', url:'https://www.whelen.com/emergency-vehicle', description:'Whelen full emergency vehicle product catalog. Use for component identification and as a starting point for distributor quote requests when valuing damaged lighting equipment.', access_level:'free' },
      { title:'Federal Signal — Emergency Vehicle Products', category:'OEM', type:'link', course_slug:'mcsa-105-valuation', source_name:'Federal Signal Corporation', url:'https://www.fedsig.com/products/emergency-vehicle-products', description:'Federal Signal product line — Integrity, Vector, SpectraLux, and siren systems. Use for component identification and baseline valuation research.', access_level:'free' },
      { title:'Motorola Solutions — APX Radio Series', category:'OEM', type:'link', course_slug:'mcsa-105-valuation', source_name:'Motorola Solutions', url:'https://www.motorolasolutions.com/en_us/products/p25-products/apx-radios.html', description:'APX radio series overview — APX 6500, APX 8500, APX NEXT. Use to identify the specific model from damage documentation and understand feature/price tier differences.', access_level:'free' },

      // ── MCSA-106 Repair Facility ──────────────────────────────────────────
      { title:'EVT Certification — EVTCC Program Overview', category:'Standards', type:'link', course_slug:'mcsa-106-repair-facility', source_name:'Emergency Vehicle Technician Certification Commission', url:'https://www.evtcc.org/', description:'The EVTCC certifies EVTs under NFPA 1071. Use to understand technician certification levels when evaluating repair facility capability for Tier 2 and Tier 3 apparatus.', access_level:'free' },
      { title:'Pierce — Authorized Service Network', category:'OEM', type:'link', course_slug:'mcsa-106-repair-facility', source_name:'Pierce Manufacturing', url:'https://www.piercemfg.com/service/dealer-network', description:'Pierce dealer and service network locator. When routing a Pierce apparatus, this is how you find an OEM-authorized facility. Replicate for other major OEMs.', access_level:'free' },
      { title:'Braun — Service Center Locator', category:'OEM', type:'link', course_slug:'mcsa-106-repair-facility', source_name:'Braun Ambulances', url:'https://www.braunambulances.com/contact/dealer-locator/', description:'Braun ambulance dealer and service center locator. Use when routing Type I or Type III ambulance repairs requiring module OEM involvement.', access_level:'free' },

      // ── MCSA-107 Police Vehicles (existing) ──────────────────────────────
      ...
      { title:'ISO 9001 Quality Management — Adjuster Application', category:'Standards', type:'link', course_slug:'mcsa-301-file-compliance', source_name:'ISO', url:'https://www.iso.org/standard/62085.html', description:'Quality management principles that underpin the MCSA file compliance framework. Understanding ISO QMS principles helps build a sustainable internal QA program for claims operations.', access_level:'free' },
      { title:'IICRC — Standards for Claims Documentation', category:'Standards', type:'link', course_slug:'mcsa-301-file-compliance', source_name:'IICRC', url:'https://iicrc.org/standards/', description:'Documentation and inspection standards from the restoration industry. Cross-industry reference for what a defensible, carrier-ready claim file looks like.', access_level:'free' },

      // ── MCSA-201 CMCA Certification ──────────────────────────────────────
      { title:'NFPA 1901 — Standard for Automotive Fire Apparatus', category:'Standards', type:'link', course_slug:'mcsa-201-cmca-certification', source_name:'NFPA', url:'https://www.nfpa.org/codes-and-standards/all-codes-and-standards/list-of-codes-and-standards/detail?code=1901', description:'The primary manufacturing standard for fire apparatus. CMCA candidates must understand what NFPA 1901 governs — apparatus specifications that affect repair requirements and OEM involvement decisions.', access_level:'free' },
      { title:'KKK-A-1822 — Federal Ambulance Specification', category:'Standards', type:'link', course_slug:'mcsa-201-cmca-certification', source_name:'GSA', url:'https://www.gsaadvantage.gov/', description:'Federal specification for ambulance construction. The baseline standard for Type I/II/III ambulance classification — understanding it is essential for CMCA exam questions on module construction and remounting decisions.', access_level:'free' },
      { title:'NFPA 1917 — Standard for Automotive Ambulances', category:'Standards', type:'link', course_slug:'mcsa-201-cmca-certification', source_name:'NFPA', url:'https://www.nfpa.org/codes-and-standards/all-codes-and-standards/list-of-codes-and-standards/detail?code=1917', description:'NFPA 1917 covers ambulance manufacture, testing, and equipment. Replaces portions of KKK-A-1822 for newer vehicles. Know both for CMCA certification.', access_level:'free' },
    ]
